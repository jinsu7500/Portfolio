...
“개발에 대한 열정과, 끊임없는 도전”
  ...
  안녕하세요 신입개발자 박진수입니다! 소프트웨어 개발 분야에 있어서 항상 큰 열정을 가지고 임했습니다. 이는 다양한 도전으로 이어졌습니다. 최근 급증한 인건비, COVID-19의 확산 등으로 매장에서 키오스크 주문시스템을 사용하는 사례들이 많아졌습니다. 이러한 키오스크 시스템을 안드로이드 앱으로 직접 구현해보고 싶다는 생각이 들어 프로젝트를 진행하였습니다. 이 과정에서 안드로이드 앱 개발에 대한 기초적인 지식을 쌓을 수 있었습니다. 안드로이드 개발에 관한 관심은 이어서 모바일 게임 개발에 관한 관심을 불러일으켰습니다. Unity 엔진을 공부하여 안드로이드용 모바일 게임개발을 시작하였습니다. 또한 게임 프로젝트에서 서버 연동까지 진행하면서 실시간 동기화 기법 및 네트워크 통신을 구현하였습니다. 안드로이드 스튜디오, Unity 엔진 등 처음 시도해보는 분야를 독학으로 학습하면서 개발은 정말 다양한 분야가 있다는 점을 깨달았습니다.
개발에 대한 열정으로 다양한 분야의 프로젝트를 경험했습니다. 이를 통해서 여러 언어와 분야를 다룰 수 있다는 자신감을 얻었습니다.
제가 가진 이러한 장점을 활용하여 어떠한 업무를 줘도 최선을 다해 수행할 것입니다.


2. 도전과 실패 경험에 대하여

Unity를 활용하여 여러 종류 게임을 개발해보았지만, 한 번도 멀티게임 개발에 도전해 본 적은 없었습니다. 친구들과 즐길 수 있는 게임을 개발해보고 싶다는 일념으로 마음이 맞는 팀원들을 꾸려 멀티게임 개발에 도전하였습니다.
네트워크 코딩에 대한 전반적인 지식이 부족하였기에, 팀원들과 학습을 하며 개발하였습니다.
개발 도중, 사용자의 네트워크 상태에 따른 동기화 문제가 발생하였습니다. 작은 용량의 서버에서, 실시간으로 과도하게 여러 이벤트를 동기화 한 결과, 각각의 사용자에게 표시되는 출력값에 레이턴시가 걸리는 문제였습니다. 이를 해결하기 위해서, 여러 이벤트를 지속해서 동기화하는 것이 아닌, 동기화에 우선순위를 주어 사용되지 않거나, 사용이 끝난 이벤트들을 동기화를 해제시키는 방법으로 개발을 진행하였습니다.
이러한 문제를 해결하면서, 한정된 자원 내에서 효율적으로 개발을 진행해야 한다는 점을 배웠습니다.

3. 입사 후 포부

유년 시절부터 개발자를 목표로 항상 최선을 다해 왔습니다. 고등학교 학창 시절에는 친구들과 함께 C언어를 공부하며 컴퓨터 언어의 기본지식을 쌓았습니다. 대학교 입학 이후, 게임 개발 동아리에 가입하였습니다. 동아리의 여러 프로젝트에 참여하여, 알고리즘, 자료구조, 객체지향, Java, Unity 등 개발자로서 전반적인 능력을 길렀습니다.
개발을 사랑하는 제가 귀사에 입사하게 된다면, 제가 필요한 역량을 더욱 꾸준히 가꾸어 회사에 이바지할 수 있도록 최선을 다하겠습니다. 기존 업무들의 시스템을 완벽하게 이해하고 활용하기 위해 주말이나 퇴근 후의 시간을 이용하여, 개발 언어와 기술을 빠르게 익히겠습니다. 업무에 임할 때는 항상 긴장감을 유지하면서 업무에 임하도록 하겠습니다. 10년 후의 IT 전문가로서의 성장을 위해 최선을 다하겠습니다.
...
### 소스코드
https://github.com/jinsu7500/Reminder_Calendar
...
### 소스코드
+ https://github.com/jinsu7500/OpenCV_HSV_HandFind
----------------
